...
<body>
    ...
    <div class="card d-block mt-2 mx-auto p-2" style="width:30rem; height:auto">
        ...
        <div class="card-body">
            <form method="post" action="hasil5.php">
                <div class="mb-3">
                    <label for="exampleInputNo1" class="form-label">No</label>
                    <input type="number" class="form-control" id="exampleInputNo1" aria-describedby="emailHelp"
                        name="no">
                </div>
                <div class="mb-3">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="Number" class="form-control" id="exampleInputName1" name="bpjs"
                                placeholder="BPJS">
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputName1" class="form-label">Pinjaman</label>
                            <input type="Number" class="form-control" id="exampleInputName1" name="pinjaman"
                                placeholder="Pinjaman">
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputName1" class="form-label">Tabungan</label>
                            <input type="Number" class="form-control" id="exampleInputName1" name="tabungan"
                                placeholder="Tabungan">
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputName1" class="form-label">Lainnya</label>
                            <input type="Number" class="form-control" id="exampleInputName1" name="lainnya"
                                placeholder="Lainnya">
                        </div>
                    </div>
                </div>
