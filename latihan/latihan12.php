        ...
        <div class="container">
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <div class="form-text mb-2">Apabila anda telah melakukan pendaftaran, silahkan klik tombol "Cek
                        Status
                        Pendaftaran"</div>
                    <div class="d-flex gap-3">
                        <a href="#" class="btn btn-primary">Cek Status Pendaftaran</a>
                        <a href="https://www.youtube.com/watch?v=0itOCgJtNVU" class="btn btn-warning text-white">Kembali
                            ke Home</a>
    ...
    <form action="hasil12.php" method="post">
        <div class="container ">
            ...
            <div class="card shadow mb-4">
                <div class="card-body">
                    <h6 class="form-title">Data Diri Calon Pendaftar (Form yang bertanda <span
                            class="text-danger">*</span> wajib di isi)</h6>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="tel" class="form-control" id="nomorHP" placeholder="Nomor HP" name="no_siswa"
                            required>
                    </div>
                    <div class="mb-3">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="alamat" rows="3"
                            placeholder="Tidak perlu lagi menulis provinsi, kota, kecamatan & kelurahan"
                            name="alamat_rumah" required></textarea>
                    </div>
                    <div class="mb-3">
            ...
            <div class="card shadow mb-4">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="nama" placeholder="Nama Sekolah" name="nama_sekolah"
                            required>
                    </div>
                    <div class="mb-3">
                        <label for="alamat" class="form-label">Alamat Sekolah<span class="text-danger">*</span></label>
                        <textarea class="form-control" id="alamat" rows="3" placeholder="Alamat Sekolah"
                            name="alamat_sekolah" required></textarea>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label for="nama" class="form-label">Pekerjaan Ayah / Ibu / Wali <span
                                    class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="nama" placeholder="Pekerjaan"
                                name="pekerjaan_ortu" required>
                        </div>
                        <div class="mb-3">
                            <label for="nomorHP" class="form-label">Nomor HP yang bisa dihubungi<span
                                    class="text-danger">*</span></label>
                            <input type="tel" class="form-control" id="nomorHP" placeholder="Nomor HP" name="no_ortu"
                                required>
                        </div>
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="alamat" rows="3" placeholder="Alamat Lengkap"
                                name="alamat_ortu" required></textarea>
                        </div>
                    </div>
                </div>
                <!-- Button Submit -->
